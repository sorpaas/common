...
*Defined in [types.ts:41](https://github.com/polkadot-js/common/blob/d3d8caa0/packages/util/src/types.ts#L41)*
...
*Defined in [types.ts:26](https://github.com/polkadot-js/common/blob/d3d8caa0/packages/util/src/types.ts#L26)*
