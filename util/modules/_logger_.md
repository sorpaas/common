...
*Defined in [logger.ts:49](https://github.com/polkadot-js/common/blob/cbec4add/packages/util/src/logger.ts#L49)*
...
*Defined in [logger.ts:109](https://github.com/polkadot-js/common/blob/cbec4add/packages/util/src/logger.ts#L109)*
